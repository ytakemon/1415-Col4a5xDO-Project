...
qtl_6 <- scanone(pheno = pheno, pheno.col = "Alb6WK_log", probs =  best.genoprobs.192, K = K_GS, addcovar = covar.sex.creat6wk, intcovar = sex.covar, snps = GM_snps)
qtl_10 <- scanone(pheno = pheno, pheno.col = "Alb10WK_log", probs =  best.genoprobs.192, K = K_GS, addcovar = covar.sex.creat10wk, intcovar = sex.covar, snps = GM_snps)
qtl_15 <- scanone(pheno = pheno, pheno.col = "Alb15WK_log", probs =  best.genoprobs.192, K = K_GS, addcovar = covar.sex.creat15wk, intcovar = sex.covar, snps = GM_snps)

max.lod_6 <- max(qtl_6$lod$A$lod)
max.lod_10 <- max(qtl_10$lod$A$lod)
max.lod_15 <- max(qtl_15$lod$A$lod)

write( max.lod_6, file = paste0("./GBRS_reconstruction/reconstruct/best.compiled.genoprob/qtl.perm/Alb6.sex.int.perm/lod.perm.",args[1],".txt"))
write( max.lod_10, file = paste0("./GBRS_reconstruction/reconstruct/best.compiled.genoprob/qtl.perm/Alb10.sex.int.perm/lod.perm.",args[1],".txt"))
write( max.lod_15, file = paste0("./GBRS_reconstruction/reconstruct/best.compiled.genoprob/qtl.perm/Alb15.sex.int.perm/lod.perm.",args[1],".txt"))

############################
#This portion is in linux Cadillac
cd /hpcdata/ytakemon/Col4a5xDO/GBRS_reconstruction/reconstruct/best.compiled.genoprob/qtl.perm/Alb6.sex.int.perm/
grep -h . *.txt > 1000.perms.txt
#check number of lines/ permutation in file
wc -l 1000.perms.txt
cd /hpcdata/ytakemon/Col4a5xDO/GBRS_reconstruction/reconstruct/best.compiled.genoprob/qtl.perm/Alb10.sex.int.perm/
grep -h . *.txt > 1000.perms.txt
#check number of lines/ permutation in file
wc -l 1000.perms.txt
cd /hpcdata/ytakemon/Col4a5xDO/GBRS_reconstruction/reconstruct/best.compiled.genoprob/qtl.perm/Alb15.sex.int.perm/
grep -h . *.txt > 1000.perms.txt
#check number of lines/ permutation in file
wc -l 1000.perms.txt
